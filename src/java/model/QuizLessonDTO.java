...
public class QuizLessonDTO {
    ...
    public QuizLessonDTO(LocalDateTime startTime, int actualQuizTime, int correctAnswers, int unAnswers, int numberQuestions, List<DimensionResult> dimensionResults, String quizStatus) {
