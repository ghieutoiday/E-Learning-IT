            ...
            <div class="page-content bg-white">
                <div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner2.jpg);">
                    <div class="container">
                        <div class="page-banner-entry">
                            <h1 class="text-white">Price Package</h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="content-block">
                    <div class="section-area section-sp1">
                        <div class="container">
                            <div class="tabs">
                                <div class="tab active" data-tab="price-package">
                                    <a href="coursecontroller?action=detail&service=pricepackage&id=${sessionScope.courseId}">Price Package</a>
                                </div>
                            </div>
                            <div id="price-package" class="tab-content active">
                                <c:if test="${requestScope.currentAction == 'edit'}">
                                    <form method="get" action="pricepackagecontroller" class="price-package-entry">
                                        <input type="hidden" name="service" value="updatepricepackage">
                                        <input type="hidden" name="action" value="edit">

                                        
                                        <%-- L?y giá tr? t? session.pp.pricePackageID ?? g?i l?i khi submit form --%>
                                        <input type="hidden" name="PricePackageID" value="${sessionScope.pp.pricePackageID}">
                                        <input type="hidden" name="pricepackageId" value="${sessionScope.pp.pricePackageID}">

                                        <%-- L?y giá tr? courseId t? session ?? g?i l?i khi submit form --%>
                                        <input type="hidden" name="courseId" value="${sessionScope.courseId}">
                                        <input type="hidden" name="updatePricePackage" value="editStart">

                                        <div class="form-group">
                                            <label>Price Package ID</label>

                                            <input type="text" value="${sessionScope.pp.pricePackageID}" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Course</label>
                                            
                                            <input type="text" value="${sessionScope.courseId}" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input type="text" name="name" value="${sessionScope.pp.name}">
                                        </div>
                                        <div class="form-group">
                                            <label>Access Duration (days)</label>
                                            <input type="number" name="accessDuration" value="${sessionScope.pp.accessDuration}">
                                        </div>
                                        <div class="form-group">
                                            <label>List Price ($)</label>
                                            <input type="number" step="0.01" name="listPrice" value="${sessionScope.pp.listPrice}">
                                        </div>
                                        <div class="form-group">
                                            <label>Sale Price ($)</label>
                                            <input type="number" step="0.01" name="salePrice" value="${sessionScope.pp.salePrice}">
                                        </div>
                                        <div class="form-group">
                                            <label>Description</label>
                                            <textarea name="description" rows="4">${sessionScope.pp.description}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Status</label>
                                            <select name="status">
                                                <option value="Active" ${sessionScope.pp.status == 'Active' ? 'selected' : ''}>Active</option>
                                                <option value="Inactive" ${sessionScope.pp.status == 'Inactive' ? 'selected' : ''}>Inactive</option>
                                            </select>
                                        </div>
                                ...
                                <c:if test="${requestScope.currentAction == 'add'}">         
                                    <form method="get" action="pricepackagecontroller" class="price-package-entry">
                                        ...
                                        <input type="hidden" name="courseId" value="${sessionScope.courseId}">
                                        <input type="hidden" name="addPricePackage" value="addStart">
                                        <div class="form-group">
                                            <label>Course</label>
                                            <input type="text" name="courseID" value="${sessionScope.courseId}" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Name</label>
                                        ...
                                        <div class="form-group">
                                            <label>Access Duration (days)</label>
                                            <input type="number" name="accessDuration" value="">
                                        </div>
                                        <div class="form-group">
                                            <label>List Price ($)</label>
                                            <input type="number" step="0.01" name="listPrice" value="">
                                        </div>
                                        <div class="form-group">
                                            <label>Sale Price ($)</label>
                                            <input type="number" step="0.01" name="salePrice" value="">
                                        </div>
                                        <div class="form-group">
                                            <label>Description</label>
